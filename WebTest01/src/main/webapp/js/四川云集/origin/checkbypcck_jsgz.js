...
function but_ScanSerialNo_Action() {
    ...
    ScanningSerialNo_Init(inViewsKeys, parseInt(userd_AllInfo[userd_AllInfo_Index].QTY), userd_AllInfo[userd_AllInfo_Index].UOM_NAME, _div2Input, true, new Array("CLEAR"), "OUT");
};
...
function ShowTable_SingleClick_Action(tableId, index) {
    ...
    } else if (tableId == userd_TableId_3 || tableId == userd_TableId_4) {
...
function ShowTable_ShowAllInfoList(tableId) {
    if (tableId == userd_TableId_1) {
        ...
        setInnerHTML(div_IdList_5, tableCode);
    } else if (tableId == userd_TableId_3) {
