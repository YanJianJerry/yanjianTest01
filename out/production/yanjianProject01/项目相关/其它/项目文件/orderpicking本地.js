...
var hide_Pck_Chg_Tsk = "hide_Pck_Chg_Tsk";
...
var inViewsKeys = new Array(_div1Input, _div2Input, _div3Input, _div4Input, _div5Input, _div6Input, _div1Waiting);
    ...
    if (returnCode == codeValue_OK) {
        ...
        if (skuValue == getValue2(wxt_Sku_3)) {
            ...
            if (getValue(hide_Sku_Bcd_Lvl) == "2") {
                ...
                if (getValue(hide_Pck_Chg_Tsk) == "N") {
                    for (var i = 0; i < 12; i++) {
                        if (buf_LotArray[i].length > 0 && buf_LotArray[i] != "" && buf_LotArray[i] != order_LotArray[i]) {
                            startMusic();
                            if (!first_EchoMessage(getValue3(hide_Message_35).replace("&1", i + 1).replace("&2", order_LotArray[i]), first_Alert_Focus, "updateMessageBar")) {
            ...
            if (getValue(hide_Pck_Chg_Tsk) == "N") {
                showViewSingle(_div3Input, inViewsKeys);
                startMusic();
                first_EchoMessage(getValue3(hide_Message_37), first_Alert_Focus, "updateMessageBar");
                setValue(txt_Sku_3, buf_SkuValue);
                setFocus(txt_Sku_3);
                return;
            }
