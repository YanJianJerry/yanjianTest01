...
var hide_OperationType_1 = "hide_OperationType_1";
...
var hide_LocGroup_11 = "hide_LocGroup_11";
var hide_IsFromLocGroup_11 = "hide_IsFromLocGroup_11";
var QSKeys = new Array(hide_OperationType_1, hide_TERMINALNO_2, hide_WaveNo_2, hide_CARTNO_2, hide_TURNOVERBOXNO_2, hide_DELETEBOX_2, hide_CARTNO_3, hide_FMLOCATION_3, hide_FMTRACEID_3, hide_XLocationId_3, hide_customerId_3, HIDE_INVENQTY_3, hide_BOX_QTY_4, hide_SKU_4, hide_LotAtt04_4, HIDE_CHECKINVEN_4, hide_XLocationId_6, hide_SplitCartonList_7, hide_NewCartonNo_8, hide_OldCartonNo_8, hide_editime_9, hide_ScanList_10, hide_LocGroup_11, hide_IsFromLocGroup_11, "break", hide_WorkingArea_1, hide_TaskType_FromCombingCart_1, hide_RF_SKU_UD1, hide_Udf1_3, hide_Udf2_3, hide_Udf3_3, hide_MLT_PCK_TYP, hide_Tsk_Hld_Tim, hide_Mlt_Pck_Dsp);
...
var inViewsKeys = new Array(_div1Input, _div2Input, _div3Input, _div4Input, _div5Input, _div6Input, _div7Input, _div8Input, _div9Input, _div10Input, _div11Input, _div1Waiting);
...
var lbl_Message_11 = "lbl_Message_11";
...
var userd_OfflineTraceId = new Array();
...
var but_LocGroup_3 = "but_LocGroup_3";
var txt_LocGroup_3 = "txt_LocGroup_3";
...
var but_NextOneCopy_3 = "but_NextOneCopy_3";
...
var but_NextOne1_3 = "but_NextOne1_3";
var pageIndex = 0;
...
var sfc_Code_11 = getValue(hide_PageControl_11);
var div_LocGroupList_11 = "div_LocGroupList_11";
...
function initHtmlPage() {
    ...
    if (getValue2("hide_WaittingPage_KeyWord01").length > 0) {
        first_SetKeyWordIntoPage(new Array(txt_CartNo_2), txt_CartNo_2_Action);
    } else {
...
function initPageThree() {
    ...
    sfc_SetValue(txt_LocGroup_3, "", sfc_Code_3);
    ...
    sfc_SetValue(lbl_Page_3, "", sfc_Code_3);
...
function initPageEleven() {
    buf_ScanList_11 = new Array();
}
...
first_ActionControl = function (id, event) {
    ...
    if (event == null || event.keyCode == 13) {
        ...
        if (id == but_LocGroup_3) {
            doButLocGroup3Action(id);
            return;
        }
        if (id == txt_LocGroup_3) {
            doTxtLocGroup3Action(id);
            return;
        }
        ...
        if (id == but_NextOne_3) {
            doButNextOne3Action(id);
            return;
        }
        if (id == but_NextOneCopy_3) {
            doButNextOne3Action(id);
            return;
        }
        if (id == but_Confirm_3) {
        ...
        if (id == but_Confirm_11) {
            doButConfirm11Action(id);
            return;
        }
        if (id == but_Cancel_11) {
            doButCancel11Action(id);
            return;
        }
...
function autoFocus(id) {
    ...
    if (id == txt_LocGroup_3) {
        setFocus(txt_LocGroup_3);
        updateMessageBar(hide_Message_46);
        return;
    }
...
function doSpAnalyzerCartNo() {
    setValue(hide_OperationType_1, "BATCHPICKING_ZONELINKCARTON");
...
function doButConfirm2Action() {
    ...
    setValue(txt_LocGroup_3, "");
    setValue(hide_LocGroup_11, "");
    updateMessageBar("");
...
function doCartNo3GetInfoAction() {
    ...
    userd_Ptltaskid = new Array();
    userd_LoatAtt04 = new Array();
    setValue(hide_OperationType_1, "BATCHPICKING_PICKLINKCARTON");
...
function but_Cancel_2_Action(id) {
    if (getValue2("hide_WaittingPage_KeyWord01").length > 0 || (userd_FromCombiningCart_Id != null && userd_FromCombiningCart_Id.length > 0 && !userd_FromCombiningCart_IsInit)) {
...
function txt_CartNo_3_Action(id) {
    setValue(hide_IsFromLocGroup_11, "NULL");
    doCartNo3Action();
}
...
function doCartNo3Action() {
    ...
    setValue(hide_CARTNO_3, cartNoValue);
    var locGroupValue = getValue2(txt_LocGroup_3);
    setValue(hide_LocGroup_11, locGroupValue);
    userd_Location = new Array();
    userd_Sku = new Array();
    userd_SkuName = new Array();
    userd_CustomerID = new Array();
...
function getLocationInfo(responseText) {
    ...
    if (curSEQ > lastSEQUpdate3) {
        ...
        if (codeValue_OK == replyData.codeValue) {
            ...
            if (getValue(hide_IsFromLocGroup_11) != "FROM" && obj2[0].PICKTOLOCATION == "#0000" && first_EchoMessage(getValue(hide_Message_20).replace("&1", obj2[0].CARTNO), first_Confirm, "")) {
                showViewSingle(_div3Input, inViewsKeys);
                var cartNoValue = getValue2(txt_CartNo_3);
                initHtmlPage();
                BATCHPREPICKING_ACTION();
            ...
            if (obj2.indexOf("ERROR_STRING_") == 0) {
                ...
                var cartNoValue = getValue2(txt_CartNo_3);
                var locGroupValue = getValue2(hide_LocGroup_11);
                initHtmlPage();
                BATCHPREPICKING_ACTION();
                setValue(txt_CartNo_3, cartNoValue);
                setValue(txt_LocGroup_3, locGroupValue);
                autoFocus("ERROR" + txt_CartNo_3);
...
function addBuffer(obj2) {
    ...
    if (getValue(chk_Sort_3) == "N") {
        for (var i = 0; i < obj2.length; i++) {
            ...
            var offlineTraceId = obj.OFFLINETRACEID;
            ...
            userd_OfflineTraceId.push(offlineTraceId);
            ...
            if (index == -1) {
                ...
                if (flagIndex == "Y") {
                    ...
                    if (getValue(txt_LocGroup_3).length > 0 && getValue(txt_LocGroup_3) != obj.LOCGROUP1) {
                        setValue(txt_LocGroup_3, obj.LOCGROUP1);
                    }
                    flagIndex = "N";
                }
            } else {
    ...
    sfc_SetValue(lbl_Page_3, +1 + "/" + userd_AllInfo_3.length, sfc_Code_3);
    setTimeout(showLocationInfo, 1);
    autoFocus(sfc_GetNextId(txt_CartNo_3, sfc_Code_3));
}

function but_LastOne_3_Action() {
    if (pageIndex > 0) {
        pageIndex--;
        setObjValue(hideSku4Obj, userd_showSku[pageIndex]);
        setObjValue(hideFmLocation3Obj, userd_showLocation[pageIndex].toUpperCase());
        setObjValue(hideFmTraceId3Obj, userd_showTraceId[pageIndex].toUpperCase());
        setObjValue(hideCustomerId3Obj, userd_CustomerID[pageIndex]);
        sfc_SetValue(txt_FMLocation_3, userd_Location[pageIndex], sfc_Code_3);
        setObjValue(wxtFmLocation3Obj, userd_Location[pageIndex]);
        sfc_SetValue(txt_FMTraceID_3, userd_FmTraceId[pageIndex], sfc_Code_3);
        setObjValue(wxtFmTraceId3Obj, userd_FmTraceId[pageIndex]);
        setObjValue(wxtSkuDescr3Obj, userd_SkuName[pageIndex]);
        setObjValue(wxtSku3Obj, userd_Sku[pageIndex]);
        sfc_SetValue(txt_SKU_3, userd_Sku[pageIndex], sfc_Code_3);
        setObjValue(wxtUdf13Obj, userd_showUdf1[pageIndex]);
        setObjValue(wxtUdf23Obj, userd_showUdf2[pageIndex]);
        setObjValue(wxtUdf33Obj, userd_showUdf3[pageIndex]);
        setObjValue(wxtUserdefine13Obj, userd_showUserdefine1[pageIndex]);
        setObjValue(wxtUserdefine23Obj, userd_showUserdefine2[pageIndex]);
        setObjValue(wxtUserdefine33Obj, userd_Sku[pageIndex]);
        setObjValue(wxtSkuDescr4Obj, userd_SkuName[pageIndex]);
        setObjValue(wxtQty4Obj, userd_Qty[pageIndex]);
        setObjValue(wxtAllQty5Obj, userd_Qty[pageIndex]);
        sfc_SetValue(lbl_Page_3, (parseInt(pageIndex) + 1) + "/" + userd_AllInfo_3.length, sfc_Code_3);
    }
    autoFocus(txt_FMLocation_3);
}

function but_NextOne_3_Action() {
    if (pageIndex < userd_AllInfo_3.length - 1) {
        pageIndex++;
        setObjValue(hideSku4Obj, userd_showSku[pageIndex]);
        setObjValue(hideFmLocation3Obj, userd_showLocation[pageIndex].toUpperCase());
        setObjValue(hideFmTraceId3Obj, userd_showTraceId[pageIndex].toUpperCase());
...
function doTxtSku3Action() {
    ...
    var paramInfo = new Array("PCK", userd_WaveNo[0], getValue(wxt_FMLocation_3), getValue2(hide_customerId_3), "", skuValue);
    SkuBarcodeAnalyzer_SetParameterAttribute(getValue2(hide_customerId_3), "*", "*");
    SkuBarcodeAnalyzer_SetAddWhere(" AND ALLOWSHIPMENT='Y' ", getValue2(txt_CartNo_3), "BPK");
...
function goOnDoTxtSku3Action() {
    ...
    var skuInfoMessage = SkuBarcodeAnalyzer_getSpSuccessReturnMessage();
    ...
    if (returnCode == codeValue_OK) {
        ...
        first_MessageSystem(skuInfoMessage);
        doButConfirm3Action();
    } else {
...
function doButConfirm3Action() {
    ...
    if (sfc_CanFocus(txt_SKU_3, sfc_Code_3) && skuValue != getValue(wxt_SKU_3)) {
        var scanIndex = -1;
        for (var i = 0; i < userd_showSku.length; i++) {
            if (skuValue == userd_showSku[i] && fmLocationValue == userd_showLocation[i]) {
                scanIndex = i;
                break;
            }
        }
        if (scanIndex == -1) {
            ...
            setValue(txt_FMLocation_3, userd_showLocation[scanIndex]);
            setValue(txt_FMTraceID_3, userd_showTraceId[scanIndex]);
            setObjValue(wxtSkuDescr3Obj, userd_showSkuName[scanIndex]);
            setObjValue(wxtSku3Obj, userd_showSku[scanIndex]);
            setValue(txt_SKU_3, userd_showSku[scanIndex]);
            setObjValue(wxtUdf13Obj, userd_showUdf1[scanIndex]);
            setObjValue(wxtUdf23Obj, userd_showUdf2[scanIndex]);
            setObjValue(wxtUdf33Obj, userd_showUdf3[scanIndex]);
            setObjValue(wxtUserdefine13Obj, userd_showUserdefine1[scanIndex]);
            setObjValue(wxtUserdefine23Obj, userd_showUserdefine2[scanIndex]);
            setObjValue(wxtUserdefine33Obj, userd_showSku[scanIndex]);
            setObjValue(wxtSkuDescr4Obj, userd_showSkuName[scanIndex]);
            setObjValue(wxtQty4Obj, userd_showQty[scanIndex]);
            setObjValue(wxtAllQty5Obj, userd_showQty[scanIndex]);
        }
    }
    var reason = "LOCATION";
    for (var i = 0; i < userd_showLocation.length; i++) {
...
function showBoxTable() {
    ...
    smallTable += "</table>";
    setValue(hide_MLT_PCK_TYP, first_GetParameterValue(WCO_MLT_PCK_TYP, getValue(hide_customerId_3), null, p_warehouseId));
    ...
    if (MLT_PCK_TYP == "A") {
        ...
        tableMessage += "</table>";
        tableMessage = tableMessage.replace("&1", smallTable.replace("&idno", "no1").replace("&id1", "qty1").replace("&id2", "loc1").replace("&taskno", getTaskNoBuffer("LBL_LOC1_TASKNO")).replace("&qty", "<label id='LBL_LOC1_QTY'></label>").replace("&loc", "<label id='LBL_LOC_1' ></label>")).replace("&2", smallTable.replace("&idno", "no2").replace("&id1", "qty2").replace("&id2", "loc2").replace("&taskno", getTaskNoBuffer("LBL_LOC2_TASKNO")).replace("&qty", "<label id='LBL_LOC2_QTY'></label>").replace("&loc", "<label id='LBL_LOC_2' ></label>"));
    } else {
        if (MLT_PCK_TYP == "B") {
            tableMessage = "";
            ...
            if (MLT_PCK_TYP == "C") {
                ...
                tableMessage += "</table>";
                tableMessage = tableMessage.replace("&1", smallTable.replace("&idno", "no1").replace("&id1", "qty1").replace("&id2", "loc1").replace("&taskno", getTaskNoBuffer("LBL_LOC1_TASKNO")).replace("&qty", "<label id='LBL_LOC1_QTY'></label>").replace("&loc", "<label id='LBL_LOC_1' ></label>")).replace("&2", smallTable.replace("&idno", "no2").replace("&id1", "qty2").replace("&id2", "loc2").replace("&taskno", getTaskNoBuffer("LBL_LOC2_TASKNO")).replace("&qty", "<label id='LBL_LOC2_QTY'></label>").replace("&loc", "<label id='LBL_LOC_2' ></label>")).replace("&3", smallTable.replace("&idno", "no3").replace("&id1", "qty3").replace("&id2", "loc3").replace("&taskno", getTaskNoBuffer("LBL_LOC3_TASKNO")).replace("&qty", "<label id='LBL_LOC3_QTY'></label>").replace("&loc", "<label id='LBL_LOC_3' ></label>")).replace("&4", smallTable.replace("&idno", "no4").replace("&id1", "qty4").replace("&id2", "loc4").replace("&taskno", getTaskNoBuffer("LBL_LOC4_TASKNO")).replace("&qty", "<label id='LBL_LOC4_QTY'></label>").replace("&loc", "<label id='LBL_LOC_4' ></label>"));
            } else {
                if (MLT_PCK_TYP == "D") {
                    tableMessage = "";
                    ...
                    tableMessage += "</table>";
                    tableMessage = tableMessage.replace("&1", smallTable.replace("&idno", "no1").replace("&id1", "qty1").replace("&id2", "loc1").replace("&taskno", getTaskNoBuffer("LBL_LOC2_TASKNO")).replace("&qty", "<label id='LBL_LOC1_QTY'></label>").replace("&loc", "<label id='LBL_LOC_1' ></label>")).replace("&2", smallTable.replace("&idno", "no2").replace("&id1", "qty2").replace("&id2", "loc2").replace("&taskno", getTaskNoBuffer("LBL_LOC3_TASKNO")).replace("&qty", "<label id='LBL_LOC2_QTY'></label>").replace("&loc", "<label id='LBL_LOC_2' ></label>")).replace("&3", smallTable.replace("&idno", "no3").replace("&id1", "qty3").replace("&id2", "loc3").replace("&taskno", getTaskNoBuffer("LBL_LOC4_TASKNO")).replace("&qty", "<label id='LBL_LOC3_QTY'></label>").replace("&loc", "<label id='LBL_LOC_3' ></label>")).replace("&4", smallTable.replace("&idno", "no4").replace("&id1", "qty4").replace("&id2", "loc4").replace("&taskno", getTaskNoBuffer("LBL_LOC5_TASKNO")).replace("&qty", "<label id='LBL_LOC4_QTY'></label>").replace("&loc", "<label id='LBL_LOC_4' ></label>")).replace("&5", smallTable.replace("&idno", "no5").replace("&id1", "qty5").replace("&id2", "loc5").replace("&taskno", getTaskNoBuffer("LBL_LOC6_TASKNO")).replace("&qty", "<label id='LBL_LOC5_QTY'></label>").replace("&loc", "<label id='LBL_LOC_5' ></label>")).replace("&6", smallTable.replace("&idno", "no6").replace("&id1", "qty6").replace("&id2", "loc6").replace("&taskno", getTaskNoBuffer("LBL_LOC7_TASKNO")).replace("&qty", "<label id='LBL_LOC6_QTY'></label>").replace("&loc", "<label id='LBL_LOC_6' ></label>"));
                } else {
                    if (MLT_PCK_TYP == "F") {
                        tableMessage = "";
                        tableMessage += "<table width='100%' height='" + (bigTableHeight * 2) + "' border='1' align='center'>";
                        ...
                        tableMessage += "</table>";
                        tableMessage = tableMessage.replace("&1", smallTable.replace("&idno", "no1").replace("&id1", "qty1").replace("&id2", "loc1").replace("&taskno", getTaskNoBuffer("LBL_LOC1_TASKNO")).replace("&qty", "<label id='LBL_LOC1_QTY'></label>").replace("&loc", "<label id='LBL_LOC_1' ></label>")).replace("&2", smallTable.replace("&idno", "no2").replace("&id1", "qty2").replace("&id2", "loc2").replace("&taskno", getTaskNoBuffer("LBL_LOC2_TASKNO")).replace("&qty", "<label id='LBL_LOC2_QTY'></label>").replace("&loc", "<label id='LBL_LOC_2' ></label>")).replace("&3", smallTable.replace("&idno", "no3").replace("&id1", "qty3").replace("&id2", "loc3").replace("&taskno", getTaskNoBuffer("LBL_LOC3_TASKNO")).replace("&qty", "<label id='LBL_LOC3_QTY'></label>").replace("&loc", "<label id='LBL_LOC_3' ></label>")).replace("&4", smallTable.replace("&idno", "no4").replace("&id1", "qty4").replace("&id2", "loc4").replace("&taskno", getTaskNoBuffer("LBL_LOC4_TASKNO")).replace("&qty", "<label id='LBL_LOC4_QTY'></label>").replace("&loc", "<label id='LBL_LOC_4' ></label>")).replace("&5", smallTable.replace("&idno", "no5").replace("&id1", "qty5").replace("&id2", "loc5").replace("&taskno", getTaskNoBuffer("LBL_LOC5_TASKNO")).replace("&qty", "<label id='LBL_LOC5_QTY'></label>").replace("&loc", "<label id='LBL_LOC_5' ></label>")).replace("&6", smallTable.replace("&idno", "no6").replace("&id1", "qty6").replace("&id2", "loc6").replace("&taskno", getTaskNoBuffer("LBL_LOC6_TASKNO")).replace("&qty", "<label id='LBL_LOC6_QTY'></label>").replace("&loc", "<label id='LBL_LOC_6' ></label>")).replace("&7", smallTable.replace("&idno", "no7").replace("&id1", "qty7").replace("&id2", "loc7").replace("&taskno", getTaskNoBuffer("LBL_LOC7_TASKNO")).replace("&qty", "<label id='LBL_LOC7_QTY'></label>").replace("&loc", "<label id='LBL_LOC_7' ></label>")).replace("&8", smallTable.replace("&idno", "no8").replace("&id1", "qty8").replace("&id2", "loc8").replace("&taskno", getTaskNoBuffer("LBL_LOC8_TASKNO")).replace("&qty", "<label id='LBL_LOC8_QTY'></label>").replace("&loc", "<label id='LBL_LOC_8' ></label>")).replace("&9", smallTable.replace("&idno", "no9").replace("&id1", "qty9").replace("&id2", "loc9").replace("&taskno", getTaskNoBuffer("LBL_LOC9_TASKNO")).replace("&qty", "<label id='LBL_LOC9_QTY'></label>").replace("&loc", "<label id='LBL_LOC_9' ></label>"));
                    } else {
                        if (MLT_PCK_TYP == "LIST") {
                            showBoxInfo2();
                            return;
    ...
    for (var i = 0; i < userd_Location.length; i++) {
        if (userd_Location[i] == fmLocationValue) {
            ...
            if (userd_Sku[i] == skuValue && userd_FmTraceId[i] == fmTraceIdValue && userd_LoatAtt04[i] == lotAtt04Value) {
                if (userd_PickToLocation[i] == "#1") {
                    setInnerHTML2(LBL_LOC1_QTY, "<font style='color:#FFFFFF;font-size:1.0em;'>" + qty_1 + "</font><font size='" + (fontSize - 1) + "'>(" + (qtySum_1 - qty_1) + ")</font>");
                    if (qty_1 > 0) {
                    ...
                    if (userd_PickToLocation[i] == "#2") {
                        setInnerHTML2(LBL_LOC2_QTY, "<font style='color:#FFFFFF;font-size:1.0em;'>" + qty_2 + "</font><font size='" + (fontSize - 1) + "'>(" + (qtySum_2 - qty_2) + ")</font>");
                        if (qty_2 > 0) {
                        ...
                        if (userd_PickToLocation[i] == "#3") {
                            setInnerHTML2(LBL_LOC3_QTY, "<font style='color:#FFFFFF;font-size:1.0em;'>" + qty_3 + "</font><font size='" + (fontSize - 1) + "'>(" + (qtySum_3 - qty_3) + ")</font>");
                            if (qty_3 > 0) {
                            ...
                            if (userd_PickToLocation[i] == "#4") {
                                setInnerHTML2(LBL_LOC4_QTY, "<font style='color:#FFFFFF;font-size:1.0em;'>" + qty_4 + "</font><font size='" + (fontSize - 1) + "'>(" + (qtySum_4 - qty_4) + ")</font>");
                                if (qty_4 > 0) {
                                ...
                                if (userd_PickToLocation[i] == "#5") {
                                    setInnerHTML2(LBL_LOC5_QTY, "<font style='color:#FFFFFF;font-size:1.0em;'>" + qty_5 + "</font><font size='" + (fontSize - 1) + "'>(" + (qtySum_5 - qty_5) + ")</font>");
                                    if (qty_5 > 0) {
                                    ...
                                    if (userd_PickToLocation[i] == "#6") {
                                        setInnerHTML2(LBL_LOC6_QTY, "<fontstyle='color:#FFFFFF;font-size:1.0em;'>" + qty_6 + "</font><font size='" + (fontSize - 1) + "'>(" + (qtySum_6 - qty_6) + ")</font>");
                                        if (qty_6 > 0) {
                                        ...
                                        if (userd_PickToLocation[i] == "#7") {
                                            setInnerHTML2(LBL_LOC7_QTY, "<fontstyle='color:#FFFFFF;font-size:1.0em;'>" + qty_7 + "</font><font size='" + (fontSize - 1) + "'>(" + (qtySum_7 - qty_7) + ")</font>");
                                            if (qty_7 > 0) {
                                            ...
                                            if (userd_PickToLocation[i] == "#8") {
                                                setInnerHTML2(LBL_LOC8_QTY, "<font style='color:#FFFFFF;font-size:1.0em;'>" + qty_8 + "</font><font size='" + (fontSize - 1) + "'>(" + (qtySum_8 - qty_8) + ")</font>");
                                                if (qty_8 > 0) {
                                                ...
                                                if (userd_PickToLocation[i] == "#9") {
                                                    setInnerHTML2(LBL_LOC9_QTY, "<font style='color:#FFFFFF;font-size:1.0em;'>" + qty_9 + "</font><font size='" + (fontSize - 1) + "'>(" + (qtySum_9 - qty_9) + ")</font>");
                                                    if (qty_9 > 0) {
...
function getTaskNoBuffer(id) {
    var tableBufferMessage = "";
    if (first_IsAndroid()) {
        tableBufferMessage = "<div style='width:15px; height:15px; border:1px solid;border-radius:10px;display:table-cell;vertical-align:middle;text-align:center;'><span style='height:10px; line-height:10px; display:block;font-size:0.4em; color:#000; text-align:center' id='" + id + "'></span></div>";
    } else {
        tableBufferMessage = "<label id='" + id + "'></label>";
    }
    return tableBufferMessage;
}
...
function showBoxInfo2() {
    ...
    divWidth -= 18;
    var tableMessage = "<div id='showBoxInfo2Div' style='height:" + divHeight + "px;width:" + divWidth + "px;overflow-x:hidden;overflow: auto;'><!--[if lt ie 8]><div style='+zoom:1;'><![endif]--><table class='table1' width='100%' cellpadding='0' cellspacing='0'>";
    tableMessage += "<tr>";
...
function but_StockOut_3_Action(id) {
    ...
    var getPickingQty = 0;
    for (var i = 0; i < userd_showLocation.length; i++) {
        if (userd_showLocation[i] == getValue2(hide_FMLOCATION_3) && userd_showSku[i] == getValue2(wxt_SKU_3)) {
            getPickingQty = parseInt(getPickingQty) + parseInt(userd_showQty[i]);
        }
    }
    if (!first_EchoMessage(getValue(hide_Message_47).replace("&1", getValue2(wxt_SKU_3)).replace("&2", getValue2(hide_FMLOCATION_3)).replace("&3", getPickingQty), first_Confirm, "")) {
        return;
    }
...
function doButPickingLookBack3Action(id) {
    ...
    if (PickingTime != 0) {
        ...
        showViewSingle(_div1Waiting, inViewsKeys);
        var QSKeys = new Array(txt_Sku_9, txt_CartNo_3, hide_Mlt_Pck_Dsp, hide_editime_9, hide_MLT_PCK_TYP, hide_Tsk_Hld_Tim, chk_Sort_3);
...
function doButLocGroup3Action(id) {
    var cartonValue = getValue2(txt_CartNo_3);
    if (cartonValue.length == 0) {
        autoFocus(txt_CartNo_3);
        return;
...
function doTxtLocGroup3Action(id) {
    var cartonValue = getValue2(txt_CartNo_3);
    if (cartonValue.length == 0) {
        autoFocus(txt_CartNo_3);
        return;
    ...
    var locGroupValue = getValue2(txt_LocGroup_3);
    if (locGroupValue.length == 0) {
        autoFocus(sfc_GetNextId(txt_LocGroup_3, sfc_Code_3));
    } else {
        setValue(hide_IsFromLocGroup_11, "FROM");
        doCartNo3Action();
    }
}

function doButNextOne3Action(id) {
    if (userd_showLocation.length == 0) {
        autoFocus(txt_CartNo_3);
        return;
    }
    if (userd_showLocation.length == 1) {
        return;
    }
    userd_Location = new Array();
    userd_Sku = new Array();
    ...
    _prevView = _div3Input;
    showViewSingle(_div1Waiting, inViewsKeys);
    var QSKeys = new Array(wxt_FMLocation_3, wxt_SKU_3, hide_CARTNO_3, hide_Udf1_3, hide_Udf2_3, hide_Udf3_3, hide_RF_SKU_UD1, hide_WorkingArea_1, hide_TERMINALNO_2, hide_MLT_PCK_TYP, hide_Tsk_Hld_Tim, hide_Mlt_Pck_Dsp);
    doServerAction(className, "doSkipAction", QSKeys, doSkipAction);
}

function doSkipAction(responseText) {
    var replyData = null;
    try {
        replyData = eval("(" + responseText + ")");
    } catch (e) {
...
function chk_ClearQty_4_Action(id) {
}
...
function updateBoxQty(responseText) {
    ...
    if (curSEQ > lastSEQUpdate5) {
        ...
        showViewSingle(_prevView, inViewsKeys);
        var returnMessage = replyData.mesg;
        var returnMessage2 = replyData.mesg;
        if (codeValue_OK == replyData.codeValue) {
            var cartNoValue = getValue2(txt_CartNo_3);
            ...
            if (obj2.length == 0) {
                ...
                initHtmlPage();
                if (returnMessage2 != "") {
                    updateMessageBar(hide_Message_15 + ";" + returnMessage2);
                } else {
            ...
            setValue(txt_CartNo_3, cartNoValue);
            setValue(txt_LocGroup_3, obj2[0].LOCGROUP1);
            setValue(hide_CARTNO_3, cartNoValue);
            setValue(hide_LocGroup_11, obj2[0].LOCGROUP1);
            setValue(hide_TERMINALNO_2, terminalNoValue);
            showViewSingle(_div3Input, inViewsKeys);
            userd_AllInfo_3 = obj2;
            addBuffer(obj2);
        } else {
            buf_LastScanSku_9 = "";
            var returnMessage = replyData.mesg;
...
function butConfirm8Action(id) {
    ...
    showViewSingle(_div1Waiting, inViewsKeys);
    var QSKeys1 = new Array(hide_CARTNO_3, hide_Udf1_3, hide_Udf2_3, hide_Udf3_3, hide_RF_SKU_UD1, hide_WorkingArea_1, hide_TERMINALNO_2, hide_MLT_PCK_TYP, hide_Tsk_Hld_Tim, hide_LocGroup_11, hide_NewCartonNo_8, hide_OldCartonNo_8, hide_ptlTaskId_8, hide_Mlt_Pck_Dsp);
...
function returnFunction() {
    ...
    if (returnCode == codeValue_OK) {
        ...
        _prevView = _div9Input;
        showViewSingle(_div1Waiting, inViewsKeys);
        var QSKeys = new Array(txt_Sku_9, txt_CartNo_3, hide_Mlt_Pck_Dsp, hide_editime_9, hide_MLT_PCK_TYP, chk_Sort_3);
        doServerAction(className, "getPickInfoAction", QSKeys, getPickInfoAction);
    } else {
        if (returnCode == codeValue_NORECORD) {
            setFocus(txt_Sku_9);
        ...
        if (MLT_PCK_TYP == "B") {
            ...
            if (MLT_PCK_TYP == "C") {
                ...
                if (MLT_PCK_TYP == "D") {
                    tableMessage = "";
                    tableMessage += "<table width='" + bigTableWidth + "' height='" + (bigTableHeight * 2) + "' border='1' align='center'>";
                    tableMessage += "<tr height='50%'><td width='32%' align='center' valign='middle'>&1</td><td width='32%' align='center' valign='middle'>&2</td><td width='32%' align='center' valign='middle'>&3</td><td width='4%' align='center' style='border:0' border='0' valign='middle'></td></tr>";
                    tableMessage += "<tr height='50%'><td width='32%' align='center' valign='middle'>&4</td><td width='32%' align='center' valign='middle'>&5</td><td width='32%' align='center' valign='middle'>&6</td><td width='4%' align='center' style='border:0' valign='middle'></td></tr>";
                    tableMessage += "</table>";
                    tableMessage = tableMessage.replace("&1", smallTable.replace("&idno", "no1").replace("&id1", "qty1").replace("&id2", "loc1").replace("&taskno", getTaskNoBuffer("LBL_LOC1_TASKNO")).replace("&qty", "<label id='LBL_LOC1_QTY'></label>").replace("&loc", "<label id='LBL_LOC_1' ></label>")).replace("&2", smallTable.replace("&idno", "no2").replace("&id1", "qty2").replace("&id2", "loc2").replace("&taskno", getTaskNoBuffer("LBL_LOC2_TASKNO")).replace("&qty", "<label id='LBL_LOC2_QTY'></label>").replace("&loc", "<label id='LBL_LOC_2' ></label>")).replace("&3", smallTable.replace("&idno", "no3").replace("&id1", "qty3").replace("&id2", "loc3").replace("&taskno", getTaskNoBuffer("LBL_LOC3_TASKNO")).replace("&qty", "<label id='LBL_LOC3_QTY'></label>").replace("&loc", "<label id='LBL_LOC_3' ></label>")).replace("&4", smallTable.replace("&idno", "no4").replace("&id1", "qty4").replace("&id2", "loc4").replace("&taskno", getTaskNoBuffer("LBL_LOC4_TASKNO")).replace("&qty", "<label id='LBL_LOC4_QTY'></label>").replace("&loc", "<label id='LBL_LOC_4' ></label>")).replace("&5", smallTable.replace("&idno", "no5").replace("&id1", "qty5").replace("&id2", "loc5").replace("&taskno", getTaskNoBuffer("LBL_LOC5_TASKNO")).replace("&qty", "<label id='LBL_LOC5_QTY'></label>").replace("&loc", "<label id='LBL_LOC_5' ></label>")).replace("&6", smallTable.replace("&idno", "no6").replace("&id1", "qty6").replace("&id2", "loc6").replace("&taskno", getTaskNoBuffer("LBL_LOC6_TASKNO")).replace("&qty", "<label id='LBL_LOC6_QTY'></label>").replace("&loc", "<label id='LBL_LOC_6' ></label>"));
                } else {
                    if (MLT_PCK_TYP == "F") {
                        tableMessage = "";
                        tableMessage += "<table width='" + bigTableWidth + "' height='" + (bigTableHeight * 2) + "' border='1' align='center'>";
                        tableMessage += "<tr height='33%'><td width='32%' align='center' valign='middle'>&1</td><td width='32%' align='center' valign='middle'>&2</td><td width='32%' align='center' valign='middle'>&3</td><td width='4%' align='center' style='border:0' valign='middle'></td></tr>";
                        tableMessage += "<tr height='33%'><td width='32%' align='center' valign='middle'>&4</td><td width='32%' align='center' valign='middle'>&5</td><td width='32%' align='center' valign='middle'>&6</td><td width='4%' align='center' style='border:0' valign='middle'></td></tr>";
                        tableMessage += "<tr height='34%'><td width='32%' align='center' valign='middle'>&7</td><td width='32%' align='center' valign='middle'>&8</td><td width='32%' align='center' valign='middle'>&9</td><td width='4%' align='center' style='border:0' valign='middle'></td></tr>";
                        tableMessage += "</table>";
                        tableMessage = tableMessage.replace("&1", smallTable.replace("&idno", "no1").replace("&id1", "qty1").replace("&id2", "loc1").replace("&taskno", getTaskNoBuffer("LBL_LOC1_TASKNO")).replace("&qty", "<label id='LBL_LOC1_QTY'></label>").replace("&loc", "<label id='LBL_LOC_1' ></label>")).replace("&2", smallTable.replace("&idno", "no2").replace("&id1", "qty2").replace("&id2", "loc2").replace("&taskno", getTaskNoBuffer("LBL_LOC2_TASKNO")).replace("&qty", "<label id='LBL_LOC2_QTY'></label>").replace("&loc", "<label id='LBL_LOC_2' ></label>")).replace("&3", smallTable.replace("&idno", "no3").replace("&id1", "qty3").replace("&id2", "loc3").replace("&taskno", getTaskNoBuffer("LBL_LOC3_TASKNO")).replace("&qty", "<label id='LBL_LOC3_QTY'></label>").replace("&loc", "<label id='LBL_LOC_3' ></label>")).replace("&4", smallTable.replace("&idno", "no4").replace("&id1", "qty4").replace("&id2", "loc4").replace("&taskno", getTaskNoBuffer("LBL_LOC4_TASKNO")).replace("&qty", "<label id='LBL_LOC4_QTY'></label>").replace("&loc", "<label id='LBL_LOC_4' ></label>")).replace("&5", smallTable.replace("&idno", "no5").replace("&id1", "qty5").replace("&id2", "loc5").replace("&taskno", getTaskNoBuffer("LBL_LOC5_TASKNO")).replace("&qty", "<label id='LBL_LOC5_QTY'></label>").replace("&loc", "<label id='LBL_LOC_5' ></label>")).replace("&6", smallTable.replace("&idno", "no6").replace("&id1", "qty6").replace("&id2", "loc6").replace("&taskno", getTaskNoBuffer("LBL_LOC6_TASKNO")).replace("&qty", "<label id='LBL_LOC6_QTY'></label>").replace("&loc", "<label id='LBL_LOC_6' ></label>")).replace("&7", smallTable.replace("&idno", "no7").replace("&id1", "qty7").replace("&id2", "loc7").replace("&taskno", getTaskNoBuffer("LBL_LOC7_TASKNO")).replace("&qty", "<label id='LBL_LOC7_QTY'></label>").replace("&loc", "<label id='LBL_LOC_7' ></label>")).replace("&8", smallTable.replace("&idno", "no8").replace("&id1", "qty8").replace("&id2", "loc8").replace("&taskno", getTaskNoBuffer("LBL_LOC8_TASKNO")).replace("&qty", "<label id='LBL_LOC8_QTY'></label>").replace("&loc", "<label id='LBL_LOC_8' ></label>")).replace("&9", smallTable.replace("&idno", "no9").replace("&id1", "qty9").replace("&id2", "loc9").replace("&taskno", getTaskNoBuffer("LBL_LOC9_TASKNO")).replace("&qty", "<label id='LBL_LOC9_QTY'></label>").replace("&loc", "<label id='LBL_LOC_9' ></label>"));
                    } else {
                        if (MLT_PCK_TYP == "LIST") {
            ...
            if (MLT_PCK_TYP == "C") {
                ...
                if (MLT_PCK_TYP == "D") {
                    ...
                    if (MLT_PCK_TYP == "F") {
                        ...
                        tableMessage += "<tr height='34%'><td width='32%' align='center' valign='middle'>&7</td><td width='32%' align='center' valign='middle'>&8</td><td width='32%' align='center' valign='middle'>&9</td><td width='4%' align='center' style='border:0' valign='middle'></td></tr>";
                        tableMessage += "</table>";
                        tableMessage = tableMessage.replace("&1", smallTable.replace("&idno", "no1").replace("&id1", "qty1").replace("&id2", "loc1").replace("&taskno", getTaskNoBuffer("LBL_LOC1_TASKNO")).replace("&qty", "<label id='LBL_LOC1_QTY'></label>").replace("&loc", "<label id='LBL_LOC_1' ></label>")).replace("&2", smallTable.replace("&idno", "no2").replace("&id1", "qty2").replace("&id2", "loc2").replace("&taskno", getTaskNoBuffer("LBL_LOC2_TASKNO")).replace("&qty", "<label id='LBL_LOC2_QTY'></label>").replace("&loc", "<label id='LBL_LOC_2' ></label>")).replace("&3", smallTable.replace("&idno", "no3").replace("&id1", "qty3").replace("&id2", "loc3").replace("&taskno", getTaskNoBuffer("LBL_LOC3_TASKNO")).replace("&qty", "<label id='LBL_LOC3_QTY'></label>").replace("&loc", "<label id='LBL_LOC_3' ></label>")).replace("&4", smallTable.replace("&idno", "no4").replace("&id1", "qty4").replace("&id2", "loc4").replace("&taskno", getTaskNoBuffer("LBL_LOC4_TASKNO")).replace("&qty", "<label id='LBL_LOC4_QTY'></label>").replace("&loc", "<label id='LBL_LOC_4' ></label>")).replace("&5", smallTable.replace("&idno", "no5").replace("&id1", "qty5").replace("&id2", "loc5").replace("&taskno", getTaskNoBuffer("LBL_LOC5_TASKNO")).replace("&qty", "<label id='LBL_LOC5_QTY'></label>").replace("&loc", "<label id='LBL_LOC_5' ></label>")).replace("&6", smallTable.replace("&idno", "no6").replace("&id1", "qty6").replace("&id2", "loc6").replace("&taskno", getTaskNoBuffer("LBL_LOC6_TASKNO")).replace("&qty", "<label id='LBL_LOC6_QTY'></label>").replace("&loc", "<label id='LBL_LOC_6' ></label>")).replace("&7", smallTable.replace("&idno", "no7").replace("&id1", "qty7").replace("&id2", "loc7").replace("&taskno", getTaskNoBuffer("LBL_LOC7_TASKNO")).replace("&qty", "<label id='LBL_LOC7_QTY'></label>").replace("&loc", "<label id='LBL_LOC_7' ></label>")).replace("&8", smallTable.replace("&idno", "no8").replace("&id1", "qty8").replace("&id2", "loc8").replace("&taskno", getTaskNoBuffer("LBL_LOC8_TASKNO")).replace("&qty", "<label id='LBL_LOC8_QTY'></label>").replace("&loc", "<label id='LBL_LOC_8' ></label>")).replace("&9", smallTable.replace("&idno", "no9").replace("&id1", "qty9").replace("&id2", "loc9").replace("&taskno", getTaskNoBuffer("LBL_LOC8_TASKNO")).replace("&qty", "<label id='LBL_LOC9_QTY'></label>").replace("&loc", "<label id='LBL_LOC_9' ></label>"));
                    } else {
                        if (MLT_PCK_TYP == "LIST") {
                            showScanTable9();
                            return;
...
function doSpAnalyzerCartNo10() {
    setValue(hide_OperationType_1, "BATCHPICKING_LINKCARTON");
    first_SetNextMusicOff();
    _prevView = _div10Input;
    showViewSingle(_div1Waiting, inViewsKeys);
...
function showLocGroupTable() {
    var tableList = new Array();
    for (var i = 0; i < userd_AllInfo_3.length; i++) {
        if (userd_AllInfo_3[i].PICKTOLOCATION == "#0000" || tableList.join(":").indexOf(userd_AllInfo_3[i].LOCGROUP1) >= 0) {
            continue;
        }
        var info = new Array(userd_AllInfo_3[i].LOCGROUP1);
        buf_ScanList_11.push(new Array(userd_AllInfo_3[i].LOCGROUP1));
        tableList.push(info);
    }
    Table_CreateTable(div_LocGroupList_11, new Array(getValue(hide_Lbl_10)), tableList, 5, "singleClickFunction", "doubleClickFunction", "", false, false);
}

function singleClickFunction(index) {
    setValue(txt_LocGroup_3, buf_ScanList_11[index]);
}
...
function doButConfirm11Action(id) {
    showViewSingle(_div3Input, inViewsKeys);
    buf_ScanList_11 = new Array();
    var locGroupValue = getValue2(txt_LocGroup_3);
    if (locGroupValue.length > 0) {
...
function doButCancel11Action(id) {
    buf_ScanList_11 = new Array();
    showViewSingle(_div3Input, inViewsKeys);
    setValue(txt_LocGroup_3, "");
    autoFocus(txt_LocGroup_3);
}